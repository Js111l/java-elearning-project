...
public class TestUtil {
  ...
  public static final CourseItem COURSE_ITEM_WITH_COURSE_ID_2 = new CourseItem(List.of(VALID_ID_2));
  public static final CourseItem COURSE_ITEM_WITH_COURSE_ID_1 = new CourseItem(List.of(VALID_ID_1));
  public static final CourseItem COURSE_ITEM_WITH_INVALID_COURSE_ID = new CourseItem(List.of(INVALID_ID));
}
